...
const EditBookModal = ({ open, onClose, onSubmit, book, loading = false }) => {
        ...
        >
            ...
            <DialogContent sx={{ p: 3 }}>
                <Typography variant="body2" sx={{ 
                    ...
                    Update the book information below. All changes will be saved to your inventory.
                </Typography>
